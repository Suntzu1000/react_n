export default [
  {
    ...
    price: 160,
    sizes: [39, 40, 41],
    description: `Inspirado no original lançado em 1985, o Air Jordan 1 Low oferece um visual limpo e clássico que é familiar, mas moderno. Com um design icônico que combina perfeitamente com qualquer ajuste, esses sapatos são perfeitos para assumir o comando.

    Vantagens:
    - Unidade Air-Sole encapsulada para amortecimento leve.
    - Couro genuíno na parte superior para maior durabilidade e aparência premium.
    - Sola de borracha sólida para maior tração em diferentes tipos de superfícies.
    - Cor Mostrada: Palomino/Branco/Frutos Silvestres
    - Modelo: 553558-215
    - Eficácia comprovada
    
    Uma sola de borracha atemporal combina com uma palmilha macia e amortecimento Nike Air encapsulado para conforto durante todo o dia. A sola de borracha oferece tração durável em uma variedade de superfícies.`,
  },
  {
    id: "2",
